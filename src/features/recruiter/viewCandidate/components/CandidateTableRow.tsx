...
import ActionMenu from "@/features/recruiter/viewCandidate/components/ActionMenu";
    ...
    <StyledTableRow>
      {headCells.map((cell) => {
        ...
        if (id.startsWith("eval:")) {
          const competency_name = id.replace("eval:", "");
          const evaluation = candidate.interviews.find(
            (e) => e.competency.competency_name === competency_name
          );
        ...
        if (id === "actions") {
          return (
            ...
            >
              ...
              >
                <ActionMenu
                  candidate_public_id={candidate.candidate.candidate_public_id}
                  onEdit={onEdit}
                  onDelete={onDelete}
                />
              </Box>
